...
<style>
    ...
    img {float:left; margin:0 18px 0 6px; width:100%; width:100%; max-width:200px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border:1px solid #aaa; margin-bottom: 24px;}
    p {font-size: 1.2rem;}
...
<img src="images/david-copperfield-banner.jpg">
<p class="clearfix">
...
<img src="images/Grammar_School_Gate_Rochester.jpg">
<p class="clearfix">
